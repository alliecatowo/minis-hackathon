"""Tests for backend/app/synthesis/chief.py constants and prompts."""
...
class TestNarrativeAspects:
    ...
    def test_decision_frameworks_present(self):
        assert "decision_frameworks_in_practice" in NARRATIVE_ASPECTS

    def test_at_least_eight_aspects(self):
        assert len(NARRATIVE_ASPECTS) >= 8
