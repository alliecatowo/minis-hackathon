...
class TestLLMUsageLimits:
    ...
    async def test_run_agent_applies_explicit_token_caps(self):
        ...
        # request_limit is intentionally None — token budgets are the cost cap,
    ...
    def test_request_limit_is_none_not_capped(self):
        ...
        for max_turns in (20, 40, 50):
            ...
            assert limits.request_limit is None, (
                f"request_limit must be None for max_turns={max_turns}; "
                "got {limits.request_limit}"
            )
